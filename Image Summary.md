...
![13周县域火点空间分布](image/task1/Spatial_Distribution_of_County-Level_Fire_Points_(Week_13_).png)
![14周县域火点空间分布](image/task1/Spatial_Distribution_of_County-Level_Fire_Points_(Week_14_).png)
![43周县域火点空间分布](image/task1/Spatial_Distribution_of_County-Level_Fire_Points_(Week_43).png)
![春季县域火点空间分布](image/task1/Spatial_Distribution_of_Fire_Points_in_County_Areas_(_Spring_).png)
![秋季县域火点空间分布](image/task1/Spatial_Distribution_of_Fire_Points_in_County_Areas(_Autumn_).png)
...
![黑龙江农业焚烧火点数量（优化版）](image/task2/Heilongjiang_Agricultural_Burning_Hotspot_Count_(lmproved).png)
![黑龙江火点分类（优化版）](image/task2/Heilongjiang_Fire_Point_Classification_(lmproved_Version).png)
![县域农业焚烧火点数量](image/task2/Number_of_Agricultural_Burning_Hotspots_in_County_Areas.png)

## Task 3 相关图片
![县域Sen斜率分布（可能农业焚烧，2010-2019）](image/task3/County-level_Sen_Slope_Distribution_(likely_agri_burning,_2010-2019).png)
![黑龙江县域Sen斜率（可能农业焚烧，2010-2019）](image/task3/Heilongjiang_County-Level_Sen_Slope_(likely_agri_burning,_2010-2019.png)
![黑龙江省年度农业焚烧排放总量（2010-2019）](image/task3/Heilongjiang_Province_Annual_Total_Agricultural_Burning_Emissions_(2010–2019).png)
![黑龙江省年度序列与最优分割点（两段均值）](image/task3/Heilongjiang_Provincial_Annual_Sequence_and_Optimal_Cutoff_Point_(Two-Segment_Mean).png)
![未检测到显著拐点](image/task3/No_significant_turning_points_detected_.png)

## Task 4 相关图片
![农业与非农业火点月度-季节分布](image/task4/Monthly_Seasonal_Distribution_of_Agricultural_vs_Non-Agricultural_Hotspots.png)

## Challenge 1 相关图片
![按类别划分的平均火点强度](image/challenge_1/Average_Fire_Intensity_by_Label.png)
![按火点类别划分的FRP分布（箱线图）](image/challenge_1/FRP_Distribution_by_Fire_Label_(Boxplot).png)
![按火点类别划分的FRP分布（小提琴图）](image/challenge_1/FRP_Distribution_by_Fire_Label_(Violin_Plot).png)
![按类别划分的火点数量](image/challenge_1/Number_of_Fires_by_Label.png)
